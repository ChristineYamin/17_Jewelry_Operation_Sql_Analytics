...
kpi_columns[0].metric(
    "Net Revenue (MMK)",
    f"{float(summary['net_revenue']) / 1_000_000_000:,.2f}B",
)
...
kpi_columns[2].metric(
    "Estimated Profit (MMK)",
    f"{float(summary['estimated_net_profit']) / 1_000_000_000:,.2f}B",
)


kpi_columns[3].metric(
    "Average Transaction (MMK)",
    f"{float(summary['average_transaction_value']) / 1_000_000:,.2f}M",
)
